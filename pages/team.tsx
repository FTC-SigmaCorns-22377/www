...
export default function Team() {
  ...
  const members: TeamMemberProps[] = [
    ...
    {
      name: "May",
      blurb: "May is a senior at the School of Science and Math, originally from Chapel Hill. She joined FTC last year and spends her time working on miscellaneous tasks on the programming team. In her free time, she likes to play basketball and read. ",
      image: may,
      roles: [programming],
    },
    {
    ...
    {
      name: "Anirudh",
      blurb: "Anirudh is from Greensboro North Carolina. He’s very passionate about testing, design, and use of data to refine and create an amazing robot. This is his first year in the First community, however he has engineering experience in rocketry, and other club and competition based ventures.",
      image: anirudh,
      roles: [mechanical],
    },
    {
